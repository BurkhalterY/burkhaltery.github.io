export default [
  ...
  },
  {
    ...
    title: "Enseignant de Python remplaçant",
    start: "01/2025",
    end: "03/2025",
    description:
      "Chaque lundi, je donne des cours de Python à une classe d'apprentis en première année.",
    image: "companies/cpnv.png",
    skills: [{ name: "Python", icon: "python.svg" }],
  },
  {
    type: "education",
    name: "Maturité professionnelle (MP), Technique, architecture et sciences de a vie (TASV)",
  ...
  {
    type: "education",
    name: "Spécialisation Blockchain",
  ...
  {
    type: "education",
    name: "Informaticien CFC, Orientation Développement d'applications",
